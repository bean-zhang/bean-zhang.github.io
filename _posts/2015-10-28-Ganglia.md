---
layout: post
title: SODA瓶 之 监控Ganglia
---

在2015年上海开放数据应用(Shanghai Open Data Application, SODA)大赛过程中，OMNILab(Open Meta Nexus Innovation Lab)提供了部分数据平台服务，包括Git, Spark等，这些服务采用Ganglia进行近实时监控。
